...
public class DetailingController {
    ...
    @PostMapping("/parse")
    public AnalysedCompUnitDTO parseJavaFile(@RequestParam String filePath) throws FileNotFoundException {
        ...
        return summarizingService.analyseCompUnit(customCompilationUnitDTO);
    }
}